...
public class VerleihServiceImplTest
{
    ...
    @Test
    public void testeNurErsterVormerkerDarfEntleihen()
    {
        Kunde nummer1 = new Kunde(new Kundennummer(111111),"Hans","Klaus");
        Kunde nummer2 = new Kunde(new Kundennummer(788854),"Peter","Schmidt");
        _service.vormerkenFuer(_vormerkkunde, _medienListe);
        _service.vormerkenFuer(nummer1, _medienListe);
        _service.vormerkenFuer(nummer2, _medienListe);
        assertTrue(_service.istVerleihenMoeglich(_vormerkkunde, _medienListe));
        assertFalse(_service.istVerleihenMoeglich(nummer1, _medienListe));
    }
    
    @Test
    public void testeDoppeltesVormerkenUndMaximal3Vormerker()
    {
        Kunde nummer1 = new Kunde(new Kundennummer(111111),"Hans","Klaus");
        Kunde nummer2 = new Kunde(new Kundennummer(788854),"Peter","Schmidt");
        Kunde nummer3 = new Kunde(new Kundennummer(787754),"Max","Schneider");
        
        
        _service.vormerkenFuer(_vormerkkunde, _medienListe);
        _service.vormerkenFuer(nummer1, _medienListe);
        _service.vormerkenFuer(nummer2, _medienListe);
        assertFalse(_service.istVormerkenMoeglich(nummer1, _medienListe));
        assertFalse(_service.istVormerkenMoeglich(nummer3, _medienListe));
