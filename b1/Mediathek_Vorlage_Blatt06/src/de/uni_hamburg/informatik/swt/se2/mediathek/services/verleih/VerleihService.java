...
public interface VerleihService extends ObservableService
{
    ...
    /**
     * Setzt den Kunde als Vormerker auf die Liste falls dies möglich ist.
     * @param kunde
     * @param medien
     * 
     * @require kunde != null
    ...
    /**
     * Prüft ob das Vormerken möglich ist. Der Kunde darf nicht der Entleiher sein und
     * die Liste darf nicht voll sein.
     * @param kunde
     * @param medien
    ...
    /**
     * Gibt den Vormerker in der Liste für das Medium zurück.
     * @param position
     * @param medium
     * @return
     * @require kunde != null
    ...
    /**
    * Entfernt den ersten Vormerker beim ausleihen.
    * @param kunde
    * @param medien
    * 
    * @require kunde != null
